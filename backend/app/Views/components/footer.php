...
<footer class="bg-light py-16 text-gray-600">
    <div class="mx-auto px-6 max-w-7xl">
        ...
        <div class="flex sm:flex-row flex-col justify-center items-center gap-8 mb-12 text-center">
            <a href="/mb" class="font-semibold text-gray-800 hover:text-primary text-sm tracking-widest transition-colors">MOOD BOARD</a>
            <a href="/rm" class="font-semibold text-gray-800 hover:text-primary text-sm tracking-widest transition-colors">ROAD MAP</a>
        </div>
