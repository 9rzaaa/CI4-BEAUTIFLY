            ...
            <?php if ($isLoggedIn): ?>
                ...
                <div class="group relative">
                    ...
                    <div class="invisible group-hover:visible right-0 z-50 absolute opacity-0 group-hover:opacity-100 shadow-2xl backdrop-blur-xl mt-2 border border-white/10 rounded-xl w-56 overflow-hidden transition-all translate-y-2 group-hover:translate-y-0 duration-300 transform"
                        ...
                        <div class="py-1.5">
                            <!-- My Profile -->
                            <a href="/profile" class="group/item flex items-center hover:bg-[#ffffff1a] mx-1.5 px-2.5 py-2 rounded-lg text-white text-xs transition-all duration-200">
                                <div class="flex justify-center items-center bg-[#73AF6F]/20 group-hover/item:bg-[#73AF6F]/30 mr-2 rounded-lg w-7 h-7 transition-colors">
                                    <svg class="w-3.5 h-3.5 text-[#73AF6F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                    </svg>
                                </div>
                            ...
                            <!-- My Bookings -->
                            <a href="/bookings" class="group/item flex items-center hover:bg-[#ffffff1a] mx-1.5 px-2.5 py-2 rounded-lg text-white text-xs transition-all duration-200">
                                <div class="flex justify-center items-center bg-[#2F5233]/20 group-hover/item:bg-[#2F5233]/30 mr-2 rounded-lg w-7 h-7 transition-colors">
                                    <svg class="w-3.5 h-3.5 text-[#2F5233]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <!-- Logout -->
                            <a href="/auth/logout" class="group/item flex items-center hover:bg-red-500/20 mx-1.5 px-2.5 py-2 rounded-lg text-red-300 text-xs transition-all duration-200">
