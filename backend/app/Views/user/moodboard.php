...
<body class="bg-light bg-opacity-80">
    ...
    <!-- Header -->
    <header class="bg-primary bg-opacity-80">
    ...
    <!-- Footer -->
<!-- footer.php -->
<footer class="bg-[#73AF6F] py-16 text-gray-600">
...
<div class="flex sm:flex-row flex-col justify-center items-center gap-8 mb-12 text-center">
    <a href="/mb" class="font-semibold text-white hover:text-primary text-sm tracking-widest transition-colors">MOOD BOARD</a>
    <a href="/rm" class="font-semibold text-white hover:text-primary text-sm tracking-widest transition-colors">ROAD MAP</a>
</div>
...
<div class="mx-auto mt-12 max-w-5xl text-center">
    <p class="text-white text-xs leading-relaxed tracking-wide">
