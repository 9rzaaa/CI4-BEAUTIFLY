...
<body class="bg-gray-50">
    ...
    <main class="mx-auto px-6 py-16 max-w-7xl">
        ...
        <div class="gap-4 grid grid-cols-1 md:grid-cols-4">
            ...
            <div class="bg-white p-4 rounded-lg">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="font-bold text-gray-700 text-sm uppercase">PLANNED <span class="ml-2 text-gray-400">2</span></h2>
                </div>
                <div class="space-y-3">
                    <!-- Services CRUD Card -->
                    <div class="bg-white hover:shadow-md p-3 border-2 border-gray-200 rounded-lg transition-shadow">
                        ...
                        <h3 class="mb-2 font-semibold text-gray-900 text-sm">Services CRUD</h3>
                        <p class="mb-3 text-gray-600 text-xs">Manage condo listing: add, update details (price, description, photos, availability)</p>
                    ...
                    <div class="bg-white hover:shadow-md p-3 border-2 border-gray-200 rounded-lg transition-shadow">
                        ...
                        <h3 class="mb-2 font-semibold text-gray-900 text-sm">Requests CRUD</h3>
            ...
            <div class="bg-white p-4 rounded-lg">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="font-bold text-gray-700 text-sm uppercase">COMPLETE <span class="ml-2 text-gray-400">0</span></h2>
                </div>
                <div class="space-y-3 min-h-[200px]">
                    <!-- Empty -->
                </div>
